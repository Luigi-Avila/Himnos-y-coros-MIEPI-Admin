...
class FormClient
    ...
    constructor(
        ...
        fun getChoirById(
            id: String,
            apiState: (ResultAPI<ChoirDTO?>) -> Unit,
        ) {
            try {
                ...
                documentReference.get().addOnSuccessListener { documentData ->
                    ...
                    apiState.invoke(ResultAPI.Success(documentData.toObject(ChoirDTO::class.java)))
                }
            } catch (e: Exception) {
        ...
        fun deleteImageFromStorage(
            ...
            try {
                ...
                fileReference.delete().addOnSuccessListener {
                    val documentReference =
                        db.collection(FirebaseCollections.CHOIRS.toString())
                            .document(documentId)
