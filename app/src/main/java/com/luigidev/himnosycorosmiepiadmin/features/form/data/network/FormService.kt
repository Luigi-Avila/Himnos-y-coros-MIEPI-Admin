package com.luigidev.himnosycorosmiepiadmin.features.form.data.network

import com.luigidev.himnosycorosmiepiadmin.core.ResultAPI
import com.luigidev.himnosycorosmiepiadmin.features.form.data.utils.toDomainFillOut
...
class FormService
    @Inject
    constructor(private val client: FormClient) {
        fun uploadChoir(
            choir: Choir,
        ...
        fun getChoirById(
            id: String,
            apiState: (ResultAPI<ChoirFillOut>) -> Unit,
        ) {
