...
class UpdateChoirUseCase @Inject constructor(private val repository: IFormRepository) {

    operator fun invoke(id: String, choir: Choir, uploadingState: (ResultAPI<String>) -> Unit) =
