package com.luigidev.himnosycorosmiepiadmin.features.home.ui.states
...
import com.luigidev.himnosycorosmiepiadmin.features.home.ui.HomeViewModel
...
fun Menu(
    ...
    DropdownMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
        ...
        DropdownMenuItem(
            ...
            onClick = {
                expanded = false
                navigationController.navigate(Routes.FormScreen.createRoute(choirData.id))
            },
            leadingIcon = {
                Icon(
